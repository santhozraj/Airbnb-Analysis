...
st.markdown(
    f""" <style>.stApp {{
                    background:url("https://wallpapers.com/images/high/vlogger-background-j5qecm86r1w7fclh.webp");
                    background-size:cover}}
                 </style>""",
    unsafe_allow_html=True
)
st.title(":orange[AIRBNB DATA ANALYSIS]")
st.write("")

def datafr():
    df= pd.read_csv("C:/Users/santh/Desktop/project/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    with col2:
        ...
        image_path = "C://Users/santh/Downloads/home.png"
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/santh/Desktop/project/Airbnb.csv")
            return df_a
